...
public class InfoEndpointWebIntegrationTests {
	...
	public void info() throws Exception {
		client.get().uri("/application/info").exchange().expectStatus().isOk()
				.expectBody().jsonPath("beanName1.key11").isEqualTo("value11")
				.jsonPath("beanName1.key12").isEqualTo("value12")

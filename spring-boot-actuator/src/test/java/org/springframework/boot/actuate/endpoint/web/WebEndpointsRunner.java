...
import org.springframework.boot.actuate.autoconfigure.endpoint.infrastructure.WebEndpointInfrastructureManagementContextConfiguration;
...
public class WebEndpointsRunner extends Suite {
	...
	private static class ReactiveWebEndpointsRunner extends AbstractWebEndpointsRunner {
		...
		@Configuration
		@Import({ JacksonAutoConfiguration.class, WebFluxAutoConfiguration.class,
				EndpointInfrastructureAutoConfiguration.class,
				WebEndpointInfrastructureManagementContextConfiguration.class })

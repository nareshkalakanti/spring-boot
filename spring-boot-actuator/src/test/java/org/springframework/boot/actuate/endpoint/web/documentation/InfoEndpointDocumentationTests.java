				...
				.andDo(MockMvcRestDocumentation.document("info",
						responseFields(beneathPath("git"),
								fieldWithPath("branch")
										.description("Name of the Git branch. Optional"),
						fieldWithPath("commit")
								.description("Details of the Git commit. Optional"),
						fieldWithPath("commit.time")
								.description("Timestamp of the commit. Optional"),
						fieldWithPath("commit.id")
								.description("ID of the commit. Optional")),
						responseFields(beneathPath("build"),
								fieldWithPath("artifact")
										.description(
												"Artifact id of the application. Optional")
										.optional(),
								fieldWithPath("group")
										.description(
												"Group id of the application. Optional")
										.optional(),
								fieldWithPath("name")
								...
								fieldWithPath("time")
										.description(
												"Timestamp of when the application was built."
														+ " Optional")

 ...
 */
@TestPropertySource(properties = "logging.file=src/test/java/org/springframework/boot/actuate/endpoint/web/documentation/sample.log")
public class LogFileWebEndpointDocumentationTests
	...
	public void logFile() throws Exception {
		this.mockMvc.perform(get("/application/logfile")).andExpect(status().isOk())
				.andDo(MockMvcRestDocumentation.document("logfile"));
	}

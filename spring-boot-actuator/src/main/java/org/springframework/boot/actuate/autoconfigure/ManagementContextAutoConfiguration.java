...
public class ManagementContextAutoConfiguration {
	...
	protected static class SameManagementContextConfiguration
			implements SmartInitializingSingleton {

		private final Environment environment;

		public SameManagementContextConfiguration(Environment environment) {
	...
	protected static class SeparateManagementContextConfiguration
			implements SmartInitializingSingleton {

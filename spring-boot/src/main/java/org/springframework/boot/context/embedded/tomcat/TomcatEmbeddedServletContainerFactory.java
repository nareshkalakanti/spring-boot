...
public class TomcatEmbeddedServletContainerFactory
	...
	private static final class SslStoreProviderUrlStreamHandlerFactory
		...
		public SslStoreProviderUrlStreamHandlerFactory(
				SslStoreProvider sslStoreProvider) {
		...
		private static class KeyStoreUrlConnection extends URLConnection {

			private final KeyStore keyStore;

			public KeyStoreUrlConnection(URL url, KeyStore keyStore) {
				super(url);
